    ...
    <div className="relative min-h-screen overflow-hidden bg-paper font-sans text-foreground antialiased">
      ...
      <div className="relative z-10">
        <header className="sticky top-0 z-50 pt-4 sm:pt-6">
          <div className="mx-auto max-w-[1280px] px-4 sm:px-10">
            <div className="museum-glass flex items-center justify-between rounded-xl px-4 py-3 shadow-lg ring-1 ring-foreground/5 sm:px-5">
              ...
              <a href="#apply" className="shrink-0 rounded-full bg-brand-deep px-4 py-2 text-xs font-medium text-primary-foreground transition-transform hover:-translate-y-px sm:px-5 sm:text-sm">Apply Now</a>
            </div>
          </div>
        </header>
        ...
        <main id="top">
            ...
            <div className="grid items-start gap-14 lg:grid-cols-12 lg:gap-16">
              <div className="lg:col-span-7">
                ...
                <div className="mt-10 flex flex-wrap items-center gap-5">
                  <a href="#apply" className="rounded-full bg-brand-bright px-7 py-3.5 text-sm font-semibold text-primary-foreground shadow-lg shadow-brand-bright/20 transition-transform hover:-translate-y-1">Join the 1,000 Artists</a>
          ...
          <section id="apply" className="mx-auto max-w-[1280px] px-6 py-24 sm:px-10"><div className="grid overflow-hidden rounded-2xl bg-gold-light/55 ring-1 ring-brand-deep/15 lg:grid-cols-2"><img src={artistStudio} alt="Indian artist creating an original textured painting" width={1200} height={1200} loading="lazy" className="h-full min-h-96 w-full object-cover" /><div className="p-8 sm:p-12 lg:p-16"><p className="font-mono text-[10px] uppercase tracking-[0.3em] text-brand-bright">1,000 Artists of India</p><h2 className="mt-5 font-serif text-4xl text-brand-deep">Become one of the 1,000 artists</h2><p className="mt-5 text-lg leading-relaxed text-foreground/75">Paint a chapter. Become part of the story. Artists from across India are invited to submit their profiles and portfolios for consideration.</p><div className="mt-8 grid grid-cols-2 gap-6 border-y border-brand-deep/15 py-6"><div><p className="font-mono text-[9px] uppercase tracking-wider text-brand-bright">Recommended canvas</p><p className="mt-2 font-serif text-xl text-brand-deep">4 ft × 5 ft</p></div><div><p className="font-mono text-[9px] uppercase tracking-wider text-brand-bright">Medium & style</p><p className="mt-2 font-serif text-xl text-brand-deep">Artist's choice</p></div></div><p className="mt-7 text-sm leading-relaxed text-foreground/65">Applications should include name, state, artist category, experience, awards, preferred medium, portfolio, proposed theme and contact details.</p><a href="mailto:info@sevasankalpsamarpan.com?subject=Artist%20Application" className="mt-8 inline-flex rounded-full bg-brand-deep px-7 py-3.5 text-sm font-semibold text-primary-foreground transition-transform hover:-translate-y-1">Apply as an Artist</a></div></div></section>

          <section id="partner" className="border-y border-brand-deep/10 bg-gold-light/40"><div className="mx-auto grid max-w-[1280px] gap-12 px-6 py-24 sm:px-10 lg:grid-cols-12"><div className="lg:col-span-6"><p className="font-mono text-[10px] uppercase tracking-[0.3em] text-brand-bright">Partner with the mission</p><h2 className="mt-5 font-serif text-4xl text-brand-deep">Build the cultural record with us</h2><p className="mt-6 max-w-[54ch] leading-relaxed text-foreground/75">The initiative welcomes cultural institutions, universities, art organizations, galleries, philanthropic organizations and responsible corporate partners.</p></div><div className="lg:col-span-6"><div className="flex flex-wrap gap-2">{["Art Partner", "Knowledge Partner", "Exhibition Partner", "University Partner", "Documentation Partner", "Digital Museum Partner", "Logistics Partner", "Hospitality Partner", "CSR Supporter"].map(item => <span key={item} className="rounded-full border border-brand-deep/15 px-3 py-2 text-xs text-brand-deep">{item}</span>)}</div><a href="mailto:info@sevasankalpsamarpan.com?subject=Partnership%20Enquiry" className="mt-8 inline-flex rounded-full bg-brand-bright px-7 py-3.5 text-sm font-semibold text-primary-foreground transition-transform hover:-translate-y-1">Become a Partner</a></div></div></section>
